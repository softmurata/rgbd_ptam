...
class MapViewer(object):
    ...
    def update(self, refresh=False):
        ...
        if refresh:
            ...
            self.all_mappoints.extend(points)
    ...
    def view(self):
        ...
        save_window = pangolin.VarBool('menu.Save_Window', value=False, toggle=False)
        record = pangolin.VarBool('menu.Record', value=False, toggle=False)
        ...
        while not pangolin.ShouldQuit():
            ...
            if pangolin.Pushed(record):
                pangolin.DisplayBase().RecordonRender("ffmpeg:[fps=30, bps=8388608, unique_filename]//screen.avi")
